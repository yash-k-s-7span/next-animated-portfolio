        ...
        <div className="h-full flex items-center justify-between px-4 sm:px-8 md:px-12 lg:px-20 xl:px-48 text-xl">
            ...
            <div className="md:hidden lg:flex xl:w-1/3 xl:justify-center">
                <Link href='' className="text-sm bg-black rounded-md p-1 font-semibold flex items-center justify-center">
                    ...
                    <span className="w-12 h-8 rounded bg-white text-black flex items-center justify-center">.js</span>
                </Link>
            </div>
            {/* Social */}
            <div className="hidden md:flex gap-4 w-1/3">
            ...
            <div className="md:hidden">
                ...
                {/* Menu list */}
                {/* {open && (
                    <motion.div variants={listVariant} initial="closed" animate="opened" className="absolute top-0 left-0 w-screen h-screen bg-black text-white flex flex-col items-center justify-center gap-8 text-2xl z-40">
                        {link.map(link => (
