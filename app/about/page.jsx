...
const AboutPage = () => {
  ...
  const skills = ["C", "HTML", "CSS", "JavaScript","Java", "Tailwindcss", "React.js", "Next.js", "Redux", "Python", "Github", "GSAP", "Frame motion"]
          ...
          <div className="flex flex-col gap-12 justify-center" ref={skillRef}>
            ...
            >
              {skills.map((item, index) => {
                return (
                  <div key={index} className='rounded-md p-2 text-sm cursor-pointer bg-black text-white hover:bg-white hover:text-black'>
                    {item}
                  </div>
                )
              })}
          ...
          >
            ...
            >
              ...
              <div className="flex justify-between h-48">
                ...
                <div className="w-1/3 ">
                  {/* JOB TITLE */}
                  <div className="bg-white p-2 w-fit font-semibold rounded-b-lg rounded-s-lg">
                  ...
                  {/* JOB COMPANY */}
                  <div className="p-1 mx-3 rounded bg-white text-sm font-semibold w-fit">
                    Apple
                  </div>
                </div>
                {/* CENTER */}
              ...
              <div className="flex justify-between h-48">
                ...
                <div className="w-1/3 ">
                  {/* JOB TITLE */}
                  <div className="bg-white w-fit p-2 text-sm font-semibold rounded-b-lg rounded-s-lg">
                    Freelancer
                  </div>
                  {/* JOB DESC */}
                  <div className="p-3 text-sm italic">
